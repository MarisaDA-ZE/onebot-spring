...
import top.kirisamemarisa.onebotspring.mapper.onebot.ScheduledTaskMapper;
import top.kirisamemarisa.onebotspring.service.onebot.IBotConfigService;
import top.kirisamemarisa.onebotspring.service.onebot.IScheduledTaskService;
...
public class ScheduledTaskServiceImpl extends ServiceImpl<ScheduledTaskMapper, ScheduledTask>
    ...
    public void startTextTaskById(String taskId) {
        ...
        createTask(task.getCronText(), () -> {
            ...
            MessageType mType = MessageType.GROUP;
            String template = CQMessageTemplate.textListTemplate(mType, job.getGroupId(), strings);
